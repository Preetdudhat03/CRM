...
class _AddEditContactScreenState extends ConsumerState<AddEditContactScreen> {
  ...
  void initState() {
    ...
    _companyId = widget.contact?.companyId;
    ...
    _status = widget.contact?.status == ContactStatus.lead
        ...
        : (widget.contact?.status ?? ContactStatus.customer);
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final contact = ContactModel(
          id:
              widget.contact?.id ??
              '', // Service/DB will handle if empty, or we let provider handle it
          name: _name,
          email: _email,
          phone: _phone,
          company: _company,
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      maxLength:
                                          10, // Limit length to 15 digits (E.164 standard)
                                      inputFormatters: [
                          ...
                          FadeInSlide(
                            delay: 0.3,
                            child: TextFormField(
                              key: ValueKey('company_field_$_company'),
